...
echo "🎬 Creating LinguaLink D2D Privacy Ad (Fixed)..."
...
ffmpeg -y -f lavfi -i "color=c=${PURPLE_COLOR}:size=${WIDTH}x${HEIGHT}:duration=8:rate=${FPS}" \
    -vf "drawtext=text='LinguaLink':fontsize=140:fontcolor=white:x=(w-text_w)/2:y=(h-text_h)/2-250:fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf,
         ...
         drawtext=text='[PHONE] ↔ [PHONE]':fontsize=60:fontcolor=white:x=(w-text_w)/2:y=(h-text_h)/2-10:fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf,
...
ffmpeg -y -f lavfi -i "color=c=${PURPLE_COLOR}:size=${WIDTH}x${HEIGHT}:duration=12:rate=${FPS}" \
    -vf "drawtext=text='Your Conversations Are Private':fontsize=60:fontcolor=white:x=(w-text_w)/2:y=80:fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf,
         ...
         drawtext=text='[CHECK] End-to-end encryption for message content':fontsize=32:fontcolor=white:x=120:y=250:fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf,
         drawtext=text='[CHECK] We cannot read your translations':fontsize=32:fontcolor=white:x=120:y=290:fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf,
         drawtext=text='[CHECK] Conversations stay between participants':fontsize=32:fontcolor=white:x=120:y=330:fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf,
         
         drawtext=text='[LOCK]':fontsize=80:fontcolor=0xFFD700:x=(w-text_w)/2:y=400:fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf,
         
         drawtext=text='Note: This free app is supported by ads which may':fontsize=25:fontcolor=0xC0C0C0:x=(w-text_w)/2:y=520:fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf,
         drawtext=text='collect anonymous usage data. Premium users':fontsize=25:fontcolor=0xC0C0C0:x=(w-text_w)/2:y=550:fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf,
         drawtext=text='enjoy an ad-free experience.':fontsize=25:fontcolor=0xC0C0C0:x=(w-text_w)/2:y=580:fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf,
...
ffmpeg -y -f lavfi -i "color=c=${PURPLE_COLOR}:size=${WIDTH}x${HEIGHT}:duration=10:rate=${FPS}" \
    -vf "drawtext=text='LinguaLink':fontsize=120:fontcolor=white:x=(w-text_w)/2:y=(h-text_h)/2-220:fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf,
         ...
         drawtext=text='[PHONE] → [LOCK] → [PHONE]':fontsize=50:fontcolor=0xFFD700:x=(w-text_w)/2:y=(h-text_h)/2-40:fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSans-Bold.ttf,
