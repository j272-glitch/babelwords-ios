...
final class SubscriptionBridge: NSObject {
    ...
    private func injectProxyScript(in webView: WKWebView) {
        let script = """
        (function(){
          if (window.BabelWordsSubscriptionBridge || window.LinguaVibeSubscriptionBridge || window.AndroidSubscriptionBridge) return;
          var bridge = {
          ...
          window.BabelWordsSubscriptionBridge = bridge;
